...
In addition to serving as a developer, I was the Lead Test Analyst (LTA), coordinating UAT testing for business SMEs and testers to implement masked production data within the enterprise test environments for over 60 applications. 
4. 
I also fulfilled the function of an ETL developer to help implement data pipelines and database workflows for a data masking project.
